...
archfile = 'noweekends' + str(epochs) + "_" + str(batchsize)  + "_" + combi + "_inks_binary_arch.json"

weightsfile = 'noweekends' + str(epochs) + "_" + str(batchsize) + "_" + combi + "_inks_binary_wts.h5"
