...
epochs, regu, batchsize = 150, 0.001, 64#  int(sys.argv[1]), float(sys.argv[2]),  int(sys.argv[3])
...
aucfname = str(num_maxpools) + "maxplools_"+ str(epochs) + "_" + str(regu) + "_" + str(batchsize) + "_aucs_med_CNNsiam.csv"
arr, aucarr = [], []


for infile in os.listdir("../data/dzne/linkdata_med/"): #['stats_dzne_dsp_max120']:#
